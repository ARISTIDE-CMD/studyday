...
const dictionaries = {
  fr: {
    ...
    postLogin: {
      ...
      e2eeTitle: 'Restauration chiffrement requise',
      e2eeDescription:
        'Entre ta phrase secrete pour restaurer ta cle de chiffrement et afficher tes donnees sur cet appareil.',
      e2eePassphrasePlaceholder: 'Phrase secrete (min. 8 caracteres)',
      e2eePassphraseRequired: 'Entre une phrase secrete de 8 caracteres minimum.',
      e2eeRestore: 'Restaurer et ouvrir',
      e2eeRestoreError: 'Impossible de restaurer la cle. Verifie la phrase secrete.',
      skip: 'Passer',
    ...
    profile: {
      ...
      encryptionRestoreCloud: 'Restaurer depuis cloud',
      encryptionExportSuccess: 'Sauvegarde de cle creee, enregistree dans le cloud et copiee.',
      encryptionImportSuccess: 'Cle restauree avec succes.',
      encryptionCloudImportSuccess: 'Cle restauree depuis le cloud avec succes.',
      encryptionUnavailable: 'La sauvegarde securisee de cle nest pas disponible sur cet appareil.',
      encryptionUnsupportedRuntimeHint:
        'Cet appareil/runtime ne supporte pas le chiffrement securise requis (WebCrypto). Essaie avec un appareil/build compatible.',
      ...
      encryptionCloudImportError: 'Impossible de restaurer la cle depuis le cloud.',
  ...
  en: {
    ...
    postLogin: {
      ...
      e2eeTitle: 'Encryption restore required',
      e2eeDescription:
        'Enter your secret passphrase to restore your encryption key and decrypt data on this device.',
      e2eePassphrasePlaceholder: 'Secret passphrase (min. 8 characters)',
      e2eePassphraseRequired: 'Enter a passphrase with at least 8 characters.',
      e2eeRestore: 'Restore and continue',
      e2eeRestoreError: 'Unable to restore key. Check your passphrase.',
      skip: 'Skip',
    ...
    profile: {
      ...
      encryptionRestoreCloud: 'Restore from cloud',
      encryptionExportSuccess: 'Key backup created, saved to cloud, and copied.',
      encryptionImportSuccess: 'Key restored successfully.',
      encryptionCloudImportSuccess: 'Key restored from cloud successfully.',
      encryptionUnavailable: 'Secure key backup is unavailable on this device.',
      encryptionUnsupportedRuntimeHint:
        'This device/runtime does not support the required secure crypto APIs (WebCrypto). Use a compatible device/build.',
      ...
      encryptionCloudImportError: 'Unable to restore key from cloud.',
